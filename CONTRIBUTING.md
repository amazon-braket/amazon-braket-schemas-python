...
When filing an issue, please check [existing open](https://github.com/aws/amazon-braket-schemas-python/issues) and [recently closed](https://github.com/aws/amazon-braket-schemas-python/issues?utf8=%E2%9C%93&q=is%3Aissue%20is%3Aclosed%20) issues to make sure somebody else hasn't already
...
1. Create a fork of this repository on GitHub. You should end up with a fork at `https://github.com/<username>/amazon-braket-schemas-python`.
   1. Follow the instructions at [Fork a Repo](https://help.github.com/en/articles/fork-a-repo) to fork a GitHub repository.
1. Clone your fork of the repository: `git clone https://github.com/<username>/amazon-braket-schemas-python` where `<username>` is your github username.
...
1. cd into the amazon-braket-schemas-python folder: `cd amazon-braket-schemas-python` or `cd /environment/amazon-braket-schemas-python`
1. Run the following tox command and verify that all unit tests pass: `tox -e py37`

You can also pass in various pytest arguments `tox -e py37 -- your-arguments` to run selected tests. For more information, please see [pytest usage](https://docs.pytest.org/en/stable/usage.html).
...
For an example file with docstrings, see [the `circuit` module](https://github.com/aws/amazon-braket-schemas-python/blob/main/src/braket/circuits/circuit.py).
...
Looking at the existing issues is a great way to find something to contribute on. As our projects, by default, use the default GitHub issue labels ((enhancement/bug/duplicate/help wanted/invalid/question/wontfix), looking at any ['help wanted'](https://github.com/aws/amazon-braket-schemas-python/labels/help%20wanted) issues is a great place to start.
...
See the [LICENSE](https://github.com/aws/amazon-braket-schemas-python/blob/main/LICENSE) file for our project's licensing. We will ask you to confirm the licensing of your contribution.
