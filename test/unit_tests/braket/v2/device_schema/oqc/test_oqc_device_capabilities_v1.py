...
from braket.v2.device_schema.oqc.oqc_device_capabilities_v1 import OqcDeviceCapabilities
...
def test_valid(valid_input):
    ...
    assert result.braketSchemaHeader.name == "braket.v2.device_schema.oqc.oqc_device_capabilities"
