...
from braket.v2.device_schema.standardized_gate_model_qpu_device_properties_v2 import (
...
def test_valid(valid_input):
    ...
    assert (
        ...
        == "braket.v2.device_schema.standardized_gate_model_qpu_device_properties"
    )
