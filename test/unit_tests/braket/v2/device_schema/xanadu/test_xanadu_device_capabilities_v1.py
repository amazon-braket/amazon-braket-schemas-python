...
from braket.v2.device_schema.xanadu.xanadu_device_capabilities_v1 import XanaduDeviceCapabilities
...
def test_valid(valid_input):
    ...
    assert (
        ...
        == "braket.v2.device_schema.xanadu.xanadu_device_capabilities"
    )
