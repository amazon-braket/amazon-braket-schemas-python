...
from braket.v2.device_schema import GateModelParameters
...
def valid_input():
    return {
        "braketSchemaHeader": {
            "name": "braket.v2.device_schema.ionq.ionq_device_parameters",
            "version": "1",
        },
...
def test_valid(valid_input):
    ...
    assert result.braketSchemaHeader.name == "braket.v2.device_schema.ionq.ionq_device_parameters"
...
def test_error_mitigation(valid_input):
    ...
    em_str = "braket.v2.device_schema.error_mitigation.debias.Debias"
