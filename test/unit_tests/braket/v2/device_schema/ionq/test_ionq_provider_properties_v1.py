...
from braket.v2.device_schema.error_mitigation import Debias, ErrorMitigationProperties
...
def test_valid(valid_input):
    ...
    assert result.braketSchemaHeader.name == "braket.v2.device_schema.ionq.ionq_provider_properties"
...
def test_error_mitigation(valid_input):
    ...
    em_json = {
        "braket.v2.device_schema.error_mitigation.debias.Debias": {"minimumShots": minimum_shots}
    }
