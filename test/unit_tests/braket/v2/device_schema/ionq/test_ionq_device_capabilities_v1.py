...
from braket.v2.device_schema.error_mitigation import Debias
from braket.v2.device_schema.ionq.ionq_device_capabilities_v1 import IonqDeviceCapabilities
...
def test_valid(valid_input):
    ...
    assert result.braketSchemaHeader.name == "braket.v2.device_schema.ionq.ionq_device_capabilities"
...
def test_valid_standardized():
    ...
    valid_input["standardized"] = {
        "braketSchemaHeader": {
            "name": "braket.v2.device_schema.standardized_gate_model_qpu_device_properties",
            "version": "3",
        },
        "oneQubitProperties": {
            "0": {
