...
import json
from braket.v2.schema_common import BraketSchemaBase
from braket.v2.device_schema.aqt.aqt_device_capabilities_v1 import AqtDeviceCapabilities
...
def test_schema_parse_obj():
    input = {
        ...
        "braketSchemaHeader": {
            "name": "braket.v2.device_schema.aqt.aqt_device_capabilities",
            "version": "1",
        },
        "deviceParameters": {
            "definitions": {
            ...
            "properties": {
                "braketSchemaHeader": {
                    "const": {
                        "name": "braket.v2.device_schema.common.gate_model_device_parameters",
                        "version": "1",
                    },
                    "default": {
                        "name": "braket.v2.device_schema.common.gate_model_device_parameters",
        ...
        "provider": {
            "braketSchemaHeader": {
                "name": "braket.v2.device_schema.aqt.aqt_provider_properties",
                "version": "1",
            },
            "properties": {
