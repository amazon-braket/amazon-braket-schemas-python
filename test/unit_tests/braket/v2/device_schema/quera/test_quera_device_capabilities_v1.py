...
from braket.v2.device_schema.quera import QueraDeviceCapabilities
...
def valid_input():
    input = {
        ...
        "paradigm": {
            "braketSchemaHeader": {
                "name": "braket.v2.device_schema.quera.quera_ahs_paradigm_properties",
                "version": "1",
            },
            "qubitCount": 256,
            "lattice": {
...
def test_valid(valid_input):
    ...
    assert (
        result.braketSchemaHeader.name == "braket.v2.device_schema.quera.quera_device_capabilities"
    )
