...
def test_valid(annealing_duration, max_results):
    input = {
        "braketSchemaHeader": {
            "name": "braket.v2.device_schema.dwave.dwave_advantage_device_level_parameters",
            "version": "1",
        },
...
def test_invalid_attribute_name():
    ...
    device_parameters = {
        "braketSchemaHeader": {
            "name": "braket.v2.device_schema.dwave.dwave_advantage_device_parameters",
            "version": "1",
        },
        "deviceLevelParameters": input,
    }
    validate(device_parameters, DwaveAdvantageDeviceParameters.model_json_schema())
