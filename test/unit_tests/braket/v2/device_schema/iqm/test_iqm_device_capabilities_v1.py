...
from braket.v2.device_schema.iqm.iqm_device_capabilities_v1 import IqmDeviceCapabilities
...
openqasm_valid_input = {
    "braketSchemaHeader": {
        "name": "braket.v2.device_schema.iqm.iqm_device_capabilities",
        "version": "1",
    },
    "service": {
        "braketSchemaHeader": {
...
def test_valid(valid_input):
    ...
    assert result.braketSchemaHeader.name == "braket.v2.device_schema.iqm.iqm_device_capabilities"
