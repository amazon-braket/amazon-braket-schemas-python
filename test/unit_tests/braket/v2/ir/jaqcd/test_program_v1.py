...
from braket.v2.ir.jaqcd import BitFlip, CNot, EndVerbatimBox, Expectation, H, StartVerbatimBox
from braket.v2.ir.jaqcd.program_v1 import Program
...
def test_instruction_no_results():
    ...
    assert Program.model_validate_json(program.model_dump_json()) == program
