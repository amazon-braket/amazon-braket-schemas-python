...
from braket.v2.ir.openqasm.program_v1 import Program as OpenQASMProgram
...
def test_arbitrary_openqasm_program():
    ...
    assert obj.braketSchemaHeader.name == "braket.v2.ir.openqasm.program"
    assert obj.source == "this is a string."


def test_parse_obj():
    obj = OpenQASMProgram(source="this is a string.")
    assert obj == OpenQASMProgram.model_validate(obj.model_dump())
