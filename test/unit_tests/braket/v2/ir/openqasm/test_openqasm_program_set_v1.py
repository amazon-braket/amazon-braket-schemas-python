...
from braket.v2.ir.openqasm.program_set_v1 import ProgramSet
from braket.v2.ir.openqasm.program_v1 import Program
from braket.v2.schema_common import BraketSchemaHeader
...
def test_load_program_set():
    valid_action = json.dumps(
        {
            "braketSchemaHeader": {"name": "braket.v2.ir.openqasm.program_set", "version": "1"},
            "programs": [
                {
                    "source": "OPENQASM 3.0;\nqubit[1] q;\nrx(a+b) q[0];",
    ...
    assert schema == {
        ...
        "properties": {
            "braketSchemaHeader": {
                ...
                "default": {"name": "braket.v2.ir.openqasm.program_set", "version": "1"},
            },
            "programs": {
                "title": "Programs",
                "type": "array",
