...
class AnnealingTaskResult(BraketSchemaBase):
    ...
    braketSchemaHeader: Annotated[
        BraketSchemaHeader, Field(default=_ANNEALING_TASK_RESULT_HEADER)
    ] = Field(default=_ANNEALING_TASK_RESULT_HEADER)
    solutions: Optional[list[conlist(conint(ge=-1, le=3), min_length=1)]] = Field(default=None)
    solutionCounts: Optional[list[conint(ge=0)]] = Field(default=None)
    values: Optional[list[float]] = Field(default=None)
    variableCount: Optional[conint(ge=0)] = Field(default=None)
