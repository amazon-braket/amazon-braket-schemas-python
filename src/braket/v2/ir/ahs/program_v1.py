...
from braket.v2.ir.ahs.atom_arrangement import AtomArrangement
from braket.v2.ir.ahs.hamiltonian import Hamiltonian
...
class Program(BraketSchemaBase):
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(name="braket.v2.ir.ahs.program", version="1")
