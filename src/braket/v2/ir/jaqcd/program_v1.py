...
from braket.v2.ir.jaqcd.instructions import (
    CV,
    CY,
    CZ,
    ECR,
...
from braket.v2.ir.jaqcd.results import (
    AdjointGradient,
    Amplitude,
    DensityMatrix,
    Expectation,
...
class Program(BraketSchemaBase):
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(name="braket.v2.ir.jaqcd.program", version="1")
