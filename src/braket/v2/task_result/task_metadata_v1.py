...
from braket.v2.device_schema.dwave import (
    Dwave2000QDeviceParameters,
    DwaveAdvantageDeviceParameters,
    DwaveDeviceParameters,
)
from braket.v2.device_schema.ionq import IonqDeviceParameters
from braket.v2.device_schema.iqm import IqmDeviceParameters
from braket.v2.device_schema.oqc import OqcDeviceParameters
from braket.v2.device_schema.rigetti import RigettiDeviceParameters
from braket.v2.device_schema.simulators import GateModelSimulatorDeviceParameters
from braket.v2.device_schema.xanadu import XanaduDeviceParameters
...
class TaskMetadata(BraketSchemaBase):
    ...
    _TASK_METADATA_HEADER = BraketSchemaHeader(
        name="braket.v2.task_result.task_metadata", version="1"
    )
