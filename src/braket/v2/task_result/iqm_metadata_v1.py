...
class IqmMetadata(BraketSchemaBase):
    ...
    _IQM_METADATA_HEADER = BraketSchemaHeader(
        name="braket.v2.task_result.iqm_metadata", version="1"
    )
    braketSchemaHeader: BraketSchemaHeader = Field(default=_IQM_METADATA_HEADER)
