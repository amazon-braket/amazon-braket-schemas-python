...
from braket.v2.device_schema.common.gate_model_device_parameters_v1 import GateModelDeviceParameters
from braket.v2.device_schema.ionq.ionq_device_parameters_v1 import IonqDeviceParameters
from braket.v2.device_schema.iqm.iqm_device_parameters_v1 import IqmDeviceParameters
from braket.v2.device_schema.rigetti.rigetti_device_parameters_v1 import RigettiDeviceParameters
from braket.v2.device_schema.simulators.gate_model_simulator_device_parameters_v1 import (
    GateModelSimulatorDeviceParameters,
)
from braket.v2.schema_common.schema_base import BraketSchemaBase
from braket.v2.schema_common.schema_header import BraketSchemaHeader
from braket.v2.task_result.program_set_executable_cancellation_v1 import (
    ProgramSetExecutableCancellationMetadata,
)
from braket.v2.task_result.program_set_executable_failure_v1 import (
    ProgramSetExecutableFailureMetadata,
)
from braket.v2.task_result.program_set_executable_result_v1 import (
...
class ProgramSetTaskMetadata(BraketSchemaBase):
    ...
    _PROGRAM_SET_TASK_METADATA_HEADER = BraketSchemaHeader(
        name="braket.v2.task_result.program_set_task_metadata", version="1"
    )
