...
from braket.v2.task_result.additional_metadata import AdditionalMetadata
from braket.v2.task_result.program_set_executable_failure_v1 import ProgramSetExecutableFailure
from braket.v2.task_result.program_set_executable_result_v1 import ProgramSetExecutableResult
...
class ProgramResult(BraketSchemaBase):
    ...
    _PROGRAM_SET_PROGRAM_RESULT_HEADER = BraketSchemaHeader(
        name="braket.v2.task_result.program_result", version="1"
    )
