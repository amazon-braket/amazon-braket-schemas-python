...
from braket.v2.device_schema.rigetti.rigetti_provider_properties_v1 import RigettiProviderProperties
...
class RigettiDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.rigetti.rigetti_device_capabilities", version="1"
    )
