...
from braket.v2.device_schema.device_action_properties import DeviceActionType
from braket.v2.device_schema.device_capabilities import DeviceCapabilities
from braket.v2.device_schema.gate_model_qpu_paradigm_properties_v1 import (
    GateModelQpuParadigmProperties,
)
from braket.v2.device_schema.jaqcd_device_action_properties import JaqcdDeviceActionProperties
from braket.v2.device_schema.openqasm_device_action_properties import OpenQASMDeviceActionProperties
from braket.v2.device_schema.openqasm_program_set_device_action_properties import (
    OpenQASMProgramSetDeviceActionProperties,
)
from braket.v2.device_schema.pulse.pulse_device_action_properties_v1 import (
    PulseDeviceActionProperties,
)
from braket.v2.device_schema.rigetti.rigetti_provider_properties_v2 import RigettiProviderProperties
from braket.v2.device_schema.standardized_gate_model_qpu_device_properties_v1 import (
...
class RigettiDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    Examples:
        ...
        >>> input_json = {
        ...    "braketSchemaHeader": {
        ...        "name": "braket.v2.device_schema.rigetti.rigetti_device_capabilities",
        ...        "version": "2",
        ...    },
        ...    "service": {
        ...        "braketSchemaHeader": {
        ...            "name": "braket.v2.device_schema.device_service_properties",
        ...            "version": "1",
        ...        },
        ...        "executionWindows": [
        ...            {
        ...
        ...    "paradigm": {
        ...        "braketSchemaHeader": {
        ...            "name": "braket.v2.device_schema.gate_model_qpu_paradigm_properties",
        ...            "version": "1",
        ...        },
        ...        "qubitCount": 32,
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.rigetti.rigetti_device_capabilities", version="2"
    )
