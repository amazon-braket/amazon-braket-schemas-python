...
from braket.v2.device_schema.dwave.dwave_provider_properties_v1 import DwaveProviderProperties
...
class DwaveDeviceCapabilities(DeviceCapabilities, BraketSchemaBase):
    ...
    Examples:
        ...
        >>> input_json = ...{
        ...    "braketSchemaHeader": {
        ...        "name": "braket.v2.device_schema.dwave.dwave_device_capabilities",
        ...        "version": "1",
        ...    },
        ...    "provider": {
        ...        "braketSchemaHeader": {
        ...            "name": "braket.v2.device_schema.dwave.dwave_provider_properties",
        ...            "version": "1",
        ...        },
        ...
        ...        }
        ...    },
        ...    "deviceParameters": {DwaveDeviceParameters.model_json_schema()},
        ... }
        >>> DwaveDeviceCapabilities.parse_raw_schema(json.dumps(input_json))
    """

    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.dwave.dwave_device_capabilities", version="1"
    )
