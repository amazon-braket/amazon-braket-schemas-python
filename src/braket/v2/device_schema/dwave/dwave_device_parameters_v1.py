...
from braket.v2.device_schema.dwave.dwave_2000Q_device_level_parameters_v1 import (
    Dwave2000QDeviceLevelParameters,
)
from braket.v2.device_schema.dwave.dwave_advantage_device_level_parameters_v1 import (
    DwaveAdvantageDeviceLevelParameters,
)
from braket.v2.device_schema.dwave.dwave_provider_level_parameters_v1 import (
...
class DwaveDeviceParameters(BraketSchemaBase):
    ...
    Examples:
        ...
        >>> input_json = {
        ...     "braketSchemaHeader": {
        ...         "name": "braket.v2.device_schema.dwave.dwave_device_parameters",
        ...         "version": "1",},
        ...     "providerLevelParameters": {
        ...         "braketSchemaHeader": {
        ...             "name": "braket.v2.device_schema.dwave.dwave_provider_level_parameters",
        ...             "version": "1",
        ...         },
        ...         "annealingOffsets": [1],
        ...         "beta": 1,
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.dwave.dwave_device_parameters", version="1"
    )
