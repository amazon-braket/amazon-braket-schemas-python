...
from braket.v2.device_schema.dwave.dwave_provider_level_parameters_v1 import ResultFormat
...
class DwaveAdvantageDeviceLevelParameters(BraketSchemaBase):
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.dwave.dwave_advantage_device_level_parameters", version="1"
    )
