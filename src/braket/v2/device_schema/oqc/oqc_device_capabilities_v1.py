...
from braket.v2.device_schema.oqc.oqc_provider_properties_v1 import OqcProviderProperties
...
class OqcDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    Examples:
        ...
        >>> input_json = {
        ...    "braketSchemaHeader": {
        ...        "name": "braket.v2.device_schema.oqc.oqc_device_capabilities",
        ...        "version": "1",
        ...    },
        ...    "service": {
        ...        "braketSchemaHeader": {
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.oqc.oqc_device_capabilities", version="1"
    )
