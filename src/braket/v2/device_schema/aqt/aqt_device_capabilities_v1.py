...
from braket.v2.device_schema.aqt.aqt_provider_properties_v1 import AqtProviderProperties
...
class AqtDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.aqt.aqt_device_capabilities", version="1"
    )
