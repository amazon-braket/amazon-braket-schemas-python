...
from braket.v2.device_schema.ionq.ionq_provider_properties_v1 import IonqProviderProperties
...
from braket.v2.device_schema.standardized_gate_model_qpu_device_properties_v3 import (
...
class IonqDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    Examples:
        ...
        >>> input_json = {
        ...    "braketSchemaHeader": {
        ...        "name": "braket.v2.device_schema.ionq.ionq_device_capabilities",
        ...        "version": "1",
        ...    },
        ...    "service": {
        ...        "braketSchemaHeader": {
        ...
        ...        },
        ...    },
        ...    "deviceParameters": {IonqDeviceParameters.model_json_schema()},
        ... }
        >>> IonqDeviceCapabilities.parse_raw_schema(json.dumps(input_json))
    """

    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.ionq.ionq_device_capabilities", version="1"
    )
