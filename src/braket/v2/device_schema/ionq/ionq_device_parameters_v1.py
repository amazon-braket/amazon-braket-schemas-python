...
from braket.v2.device_schema.gate_model_parameters_v1 import GateModelParameters
...
class IonqDeviceParameters(BraketSchemaBase):
    ...
    Examples:
        ...
        ...    "errorMitigation": [
        ...        {
        ...            "type": "braket.v2.device_schema.error_mitigation.debias.Debias"
        ...        }
        ...    ]
        ... }
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.ionq.ionq_device_parameters", version="1"
    )
    ...
    @classmethod
    def validate_em(cls, value, info: ValidationInfo):
        """
        ...
        if value is None:
            return value
        return [cls._validate_em_item(item, info.field_name) for item in value]

    @staticmethod
    def _validate_em_item(value, field):
