...
from braket.v2.device_schema.blackbird_device_action_properties import (
    BlackbirdDeviceActionProperties,
)
from braket.v2.device_schema.continuous_variable_qpu_paradigm_properties_v1 import (
...
from braket.v2.device_schema.xanadu.xanadu_provider_properties_v1 import XanaduProviderProperties
...
class XanaduDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    Examples:
        ...
        >>> input_json = {
        ...    "braketSchemaHeader": {
        ...        "name": "braket.v2.device_schema.xanadu.xanadu_device_capabilities",
        ...        "version": "1",
        ...    },
        ...    "service": {
        ...        "braketSchemaHeader": {
        ...
        ...    "paradigm": {
        ...        "braketSchemaHeader": {
        ...            "name": "braket.v2.device_schema.continuous_variable_qpu_paradigm_properties",
        ...            "version": "1",
        ...        },
        ...
        ...    },
        ...    "deviceParameters": {XanaduDeviceParameters.model_json_schema()},
        ... }
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.xanadu.xanadu_device_capabilities", version="1"
    )
    ...
    provider: XanaduProviderProperties | None = None
