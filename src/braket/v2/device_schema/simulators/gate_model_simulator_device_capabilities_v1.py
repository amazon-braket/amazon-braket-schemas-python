...
from braket.v2.device_schema.simulators.gate_model_simulator_paradigm_properties_v1 import (
...
class GateModelSimulatorDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.simulators.gate_model_simulator_device_capabilities",
        version="1",
    )
