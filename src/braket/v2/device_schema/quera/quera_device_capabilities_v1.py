...
from braket.v2.device_schema.quera.quera_ahs_paradigm_properties_v1 import (
...
class QueraDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    Examples:
        ...
        >>> input_json = {
        ...    "braketSchemaHeader": {
        ...        "name": "braket.v2.device_schema.quera.quera_device_capabilities",
        ...        "version": "1",
        ...    },
        ...    "service": {
        ...        "braketSchemaHeader": {
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.quera.quera_device_capabilities", version="1"
    )
