...
from braket.v2.device_schema.iqm.iqm_provider_properties_v1 import IqmProviderProperties
...
class IqmDeviceCapabilities(BraketSchemaBase, DeviceCapabilities):
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.iqm.iqm_device_capabilities", version="1"
    )
