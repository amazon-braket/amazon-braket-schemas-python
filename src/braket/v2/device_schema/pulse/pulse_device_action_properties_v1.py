...
from braket.v2.device_schema.pulse.frame_v1 import Frame
from braket.v2.device_schema.pulse.port_v1 import Port
from braket.v2.device_schema.pulse.pulse_function_v1 import PulseFunction
...
class PulseDeviceActionProperties(BraketSchemaBase):
    ...
    Examples:
        ...
        >>> input_json = {
        ...         "braketSchemaHeader": {
        ...             "name": "braket.v2.device_schema.pulse.pulse_device_action_properties",
        ...             "version": "1",
        ...         },
    ...
    _PROGRAM_HEADER = BraketSchemaHeader(
        name="braket.v2.device_schema.pulse.pulse_device_action_properties", version="1"
    )
